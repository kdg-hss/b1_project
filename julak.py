...
SSH_PASSWORD = os.getenv("SSH_PASSWORD", "123a")
SSH_PORT = 22
...
(VMESS_GET_USERNAME, VMESS_GET_EXPIRED_DAYS, TROJAN_GET_USERNAME, TROJAN_GET_EXPIRED_DAYS,
 ...
 GET_VMESS_USER_TO_DELETE, GET_SHADOWSOCKS_USER_TO_DELETE) = range(36)
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    else: msg = f"🎉 Halo, <b>{user_name}</b>! Selamat datang kembali 👋\n\n🤖 JULAK VPN BOT 🤖\n🚀 Bot Order Otomatis Akun VPN 🚀\n\n📜 INFO SERVER 📜\n* Server : Singapura *\n* ISP : Digital Ocean *\n\n📞CONTACT ADMIN :\n➡️ 085166600428\n➡️ @rajaganjil93\n\nDomain willcard yang tersedia saat ini:\nava.game.naver.com.bot.bagusvpn.me\nsupport.zoom.us.bot.bagusvpn.me\n\nJika ingin menambahkan bug lain\nSilahkan Kirimkan bug willcard kalian ke admin."
    conn.close()
